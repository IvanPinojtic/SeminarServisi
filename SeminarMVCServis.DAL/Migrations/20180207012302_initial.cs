        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ApsUserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestMeals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestMeals_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_GuestMeals_Meals_MealId",
                        column: x => x.MealId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestMeals_GuestId",
                table: "GuestMeals",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestMeals_MealId",
                table: "GuestMeals",
                column: "MealId");

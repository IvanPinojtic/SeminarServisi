...
namespace SeminarMVCServis.GoogleAuth.Controllers
{
    ...
    public class RestaurantsController : Controller
    {
        ...
        {
            return _context.Restaurants.Include(r => r.Address).Include(r => r.Guests).Include(r => r.Meals);
        }
        ...
        public async Task<IActionResult> GetRestaurant([FromRoute] int id)
        {
            ...
            var restaurant = await _context.Restaurants.Include(r => r.Meals).Include(r => r.Guests).SingleOrDefaultAsync(m => m.Id == id);
